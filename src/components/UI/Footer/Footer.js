...
const Footer = () => {
  return (
    <footer>
        ...
        <form>
            <ul className="form-group">
              ...
              <li>
                  ...
                  <textarea name="message" id="message" rows="3" required="required" className="field-long field-textarea"></textarea>
              </li>
              <li>
      ...
      <h5 className="footer-text">&copy; <span id="year">{CURRENT_YEAR}</span> Andela bootcamp project </h5>
      </div>
    </footer>
  )
}
